...
public:
    ...
    enum audio_devices {
        ...
        // input devices
        DEVICE_IN_BUILTIN_MIC = 0x100000,
        DEVICE_IN_BLUETOOTH_SCO_HEADSET = 0x200000,
        DEVICE_IN_WIRED_HEADSET = 0x400000,
        DEVICE_IN_AUX_DIGITAL = 0x800000,
        DEVICE_IN_VOICE_CALL = 0x1000000,
        DEVICE_IN_BACK_MIC = 0x2000000,
        DEVICE_IN_FM_RX = 0x4000000,
        DEVICE_IN_DEFAULT = 0x8000000,
        DEVICE_IN_ALL = (DEVICE_IN_BUILTIN_MIC |

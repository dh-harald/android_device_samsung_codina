...
typedef enum {
    ...
    /* input devices */
    AUDIO_DEVICE_IN_COMMUNICATION         = 0x40000,
    AUDIO_DEVICE_IN_AMBIENT               = 0x80000,
    /* ^^^^ for compability */
    AUDIO_DEVICE_IN_BUILTIN_MIC           = 0x100000,
    AUDIO_DEVICE_IN_BLUETOOTH_SCO_HEADSET = 0x200000,
    AUDIO_DEVICE_IN_WIRED_HEADSET         = 0x400000,
    AUDIO_DEVICE_IN_AUX_DIGITAL           = 0x800000,
    AUDIO_DEVICE_IN_VOICE_CALL            = 0x1000000,
    AUDIO_DEVICE_IN_BACK_MIC              = 0x2000000,
#if defined(STE_FM)
    AUDIO_DEVICE_IN_FM_RX                 = 0x4000000,
#endif
    AUDIO_DEVICE_IN_DEFAULT               = 0x4000000,
